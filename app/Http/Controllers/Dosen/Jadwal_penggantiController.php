...
class Jadwal_penggantiController extends Controller
{
    ...
    //    dd($jadwal->nm_mtk);
        return view('admin.jadwal_pengganti.form_pengganti_praktek',compact('jadwal','kuliah_pengganti'));
    }
    ...
    //    dd($jadwal->nm_mtk);
        return view('admin.jadwal_pengganti.form_pengganti_teori',compact('jadwal','kuliah_pengganti'));
    }
    ...
    //    dd($jadwal->nm_mtk);
        return view('admin.jadwal_pengganti.form_pengganti_gabung',compact('jadwal','kuliah_pengganti'));
    }
   ...
   if(isset($cek_jam)){
    ...
    { 
       ...
       $w_cek = ['kd_gabung'=>$request->kd_lokal,'kd_mtk'=>$request->kd_mtk,'jam_t'=>$request->jam_t];
        $where = ['kd_mtk'=>$request->kd_mtk,'kd_lokal'=>$request->kd_lokal,'tgl_ajar_masuk'=>date('Y-m-d')];
        $w_pert = ['kd_mtk'=>$request->kd_mtk,'kd_lokal'=>$request->kd_lokal];
        $absen_pert = Absen_ajar::where($w_pert)
        ->orderByDesc('pertemuan');
       $cek_absen = Absen_ajar::where($where)
