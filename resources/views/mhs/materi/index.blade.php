                ...
                <div class="row gutters">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="doc-block">
                      ...
                      <a href="http://students.bsi.ac.id/mahasiswa/silabus/{{ $slidemhs->kd_mtk }}.zip" class="btn btn-primary btn-lg">Download</a>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="doc-block">
                      ...
                      <a href="http://students.bsi.ac.id/mahasiswa/sap/{{ $slidemhs->kd_mtk }}.zip" class="btn btn-primary btn-lg">Download</a>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="doc-block">
                      ...
                      <a href="http:// students.bsi.ac.id/mahasiswa/silabus/LTM/{{ $slidemhs->kd_mtk }}.zip" class="btn btn-primary btn-lg">Download</a>
