<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Kelola dan logout sesi aktif Anda di browser dan perangkat lain.') }}
        <img src="{{ Storage::url('public/icon/browser.png') }}" style="width:600px;height:500px;" alt="btiAdmin"/>
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Jika perlu, Anda dapat keluar dari semua sesi browser Anda yang lain di semua perangkat Anda. Beberapa sesi terbaru Anda tercantum di bawah ini; namun, daftar ini mungkin tidak lengkap. Jika Anda merasa akun Anda telah dibobol, Anda juga harus memperbarui kata sandi Anda.') }}
        </div>
