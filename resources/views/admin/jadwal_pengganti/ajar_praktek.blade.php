...
<div class="">
    ...
    <div class="row gutters">
        ...
        <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <form method="post" action="{{url('/berita-acara-praktek')}}" enctype="multipart/form-data">
            ...
            <div class="row gutters justify-content-center">
                <div class="col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                    ...
                    <div class="subscribe-form">
                        <form action="{{url('/absen-keluar-praktek-pegganti')}}" method="POST">
        ...
        <div class="tab-pane fade show active" id="mhs3" role="tabpanel" aria-labelledby="mhs-tab3">
                ...
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header text-right">
                            <form action="{{url('/absen-mhs-praktek')}}" method="post">
                                @csrf
            ...
            <input type="hidden" name="id" value="{{$id}}">
            <input type="hidden" name="id_ke" value="2">
