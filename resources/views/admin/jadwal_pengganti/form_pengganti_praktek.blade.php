...
<div class="row gutters">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            ...
            <form action="{{ url('/update-pengganti-praktek') }}" method="POST">  
                @else
                <form action="{{ url('/simpan-pengganti-praktek') }}" method="POST">
            @endif
                @csrf
                <div class="row gutters">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="kelas" type="text" placeholder="Kelas" value="{{$jadwal->kel_praktek}}" name="kelas" readonly>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                        <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge 
                                            ...
                                            @endif</span></td>
                                        {{-- <td>
                                            <form action="{{url('/pengganti-praktek')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="kel_praktek" value="{{$kp->kel_praktek}}">
                                        ...
                                        <td>
                                            @if ($kp->sts_pengajuan=='0')
                                            <form action="{{url('/hapus-pengganti-praktek')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="kel_praktek" value="{{$kp->kel_praktek}}">
                                                <input type="hidden" name="kd_mtk" value="{{$kp->kd_mtk}}">
                                                <input type="hidden" name="tgl_pengganti" value="{{$kp->tgl_klh_pengganti}}">
                                                <button type="submit" id="btnDelete" name="kirim" class="btn" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="icon-delete"></i></button>
                                            </form>
                                            @elseif($kp->sts_pengajuan=='2'&&$kp->tgl_klh_pengganti==date('Y-m-d'))
                                        <form action="/create-praktek-pengganti" method="post">
                                            @csrf
                                            <input type="hidden" name="kd_mtk" value="{{$kp->kd_mtk}}">
