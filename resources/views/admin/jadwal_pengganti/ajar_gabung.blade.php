        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="nav-tabs-container">
                ...
                <ul class="nav nav-tabs" id="myTab3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact3" aria-selected="false"><i class="icon-log-out"></i>Keluar Kelas</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
                                ...
                                <form method="post" action="{{url('/berita-acara-gabung')}}" enctype="multipart/form-data">
                                    @csrf
								<div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label class="label">File Ajar</label>
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{url('/download-file-ajar')}}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="id" value="{{$id}}">
                        ...
                        <div class="row gutters justify-content-center">
                            <div class="col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                                ...
                                <div class="subscribe-form">
                                    <form action="{{url('/absen-keluar-gabung')}}" method="POST">
                    ...
                    <div class="tab-pane fade show active" id="mhs3" role="tabpanel" aria-labelledby="mhs-tab3">
                        <div class="row gutters justify-content-center">
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                ...
                                <form action="{{url('/absen-mhs-gabung')}}" method="post">
                                            @csrf
                                            
                                                <button type="submit" class="btn btn-primary"><i class="icon-save"></i> Simpan Absen Hadir</button>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table projects-table">
                                                ...
                                                <tbody>	
                                                    ...
                                                    <input type="hidden" name="kd_lokal[{{$count}}]" value="{{$mhs->kd_lokal}}">
                                                    @php
                                                    $count++;
                                                @endphp
                                        @endforeach
