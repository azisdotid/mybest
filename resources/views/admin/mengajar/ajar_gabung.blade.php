                    ...
                    <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
                                ...
                                <form method="post" action="/berita-acara-gabung" enctype="multipart/form-data">
                                    @csrf
								<div class="card-body">
										...
										<table class="table table-hover table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td class="readmore">{{$bap->rangkuman}}</td>
                                                    <td class="readmore">{{$bap->berita_acara}}</td>
                                                    <td>
                        ...
                        <div class="row gutters justify-content-center">
                            <div class="col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                                ...
                                <div class="subscribe-form">
                                    <form action="/absen-keluar-gabung" method="POST">
                    ...
                    <div class="tab-pane fade show active" id="mhs3" role="tabpanel" aria-labelledby="mhs-tab3">
                        ...
                        <div class="row gutters justify-content-center">
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                ...
                                <form action="/absen-mhs-gabung" method="post">
                                            @csrf
