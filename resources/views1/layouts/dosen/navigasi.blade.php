<div class="sidebar-content">
  ...
  <?php
			http://says.bsi.ac.id/authenx-MDktMDEtNTk=-MjAxMjAzMzA3-MQ==.js
			$wsda=base64_encode(Auth::user()->username);
			$tglasd=base64_encode(date("Ymd"));
			$qweas=base64_encode(1);
			echo" <a href='http://says.bsi.ac.id/authenx-$tglasd-$wsda-$qweas.js' target=_blank>"; 
			?>
